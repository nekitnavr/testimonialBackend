...
async function findTestimonial(req, res, testimonialId){
    ...
    console.log(req.user.userId, testimonial.userId);
...
function getDateRange(startDateStr, endDateStr){
    ...
    if (startDate && isNaN(startDate)) throw new Error(res, 'Invalid start date format')
    if (endDate && isNaN(endDate)) throw new Error(res, 'Invalid end date format')
