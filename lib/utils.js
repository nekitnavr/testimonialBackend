...
function canTransitionStatus(fromStatus, toStatus){
    console.log(fromStatus, (statuses.indexOf(fromStatus)));
    console.log(toStatus, (statuses.indexOf(toStatus)));
    return (statuses.indexOf(toStatus) - Math.abs(statuses.indexOf(fromStatus))) === 1
}
