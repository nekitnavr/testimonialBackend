...
## Обзор
- Время выполнения составило ~26 часов
- Бонусных задач не делал
- При наличии большего времени я бы добавил unit тесты, вынес бизнес-логику из контроллеров в сервисы