...
## Обзор
- Время выполнения составило ~28 часов
- Добавил rate limiting
- При наличии большего времени я бы добавил unit тесты, вынес бизнес-логику из контроллеров в сервисы, добавил централизованный обработчик ошибок.